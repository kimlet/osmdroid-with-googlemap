...
import com.topgether.sixfoot.osmdroid.R;
 ...
 */
public class ColorPolyline extends OverlayWithIW {

    private boolean mGeodesic;
    private final Paint mPaint = new Paint();
    private final ColorLineDrawer mLineDrawer = new ColorLineDrawer(255);
    private ColorLinearRing mOutline = new ColorLinearRing(mLineDrawer);
    ...
    protected ColorPolyline.OnClickListener mOnClickListener;
     ...
     * info window popups will not function unless you handle it yourself
     */
    public ColorPolyline(MapView mapView) {
        if (mapView != null) {
    ...
    public void setOnClickListener(ColorPolyline.OnClickListener listener) {
    ...
    public void draw(final Canvas canvas, final MapView mapView, final boolean shadow) {
        ...
        mOutline.buildLinePortion(pj, mMilestoneManagers.size() > 0, mLineDrawer);
    ...
    public interface OnClickListener {
        abstract boolean onClick(ColorPolyline polyline, MapView mapView, GeoPoint eventPos);
    }

    /**
     * default behaviour when no click listener is set
     */
    protected boolean onClickDefault(ColorPolyline polyline, MapView mapView, GeoPoint eventPos) {
